...
{
    internal class MyTgcThirdPersonCamera : TgcCamera
    {
        ...
        /// </summary>
        public MyTgcThirdPersonCamera()
        {
            resetValues();
        }

        public MyTgcThirdPersonCamera(TGCVector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public MyTgcThirdPersonCamera(TGCVector3 target, TGCVector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
        ...
        public TGCVector3 Posoffset { get; private set; } = TGCVector3.Empty;
        ...
        public override void UpdateCamera(float elapsedTime)
        {
            ...
            SetCamera(position+Posoffset, targetCenter+Centeroffset);
        }
        ...
        public void addPos(TGCVector3 t)
        {
           Posoffset += t;
        }
        public void addCenter(TGCVector3 t)
        {
            Centeroffset += t;
        }
        /// <summary>
